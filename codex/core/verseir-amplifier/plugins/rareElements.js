...
const RARE_ELEMENT_DOMAINS = Object.freeze([
  Object.freeze({
    id: 'lightning',
    label: 'Lightning',
    lexemes: ['lightning', 'thunder', 'stormbright', 'static', 'volt', 'arc', 'spark'],
    archetypes: [
  ...
  Object.freeze({
    id: 'light',
    label: 'Light',
    lexemes: ['light', 'dawn', 'halo', 'gleam', 'radiant', 'sun', 'lumen', 'shine'],
    archetypes: [
  ...
  Object.freeze({
    id: 'dark',
    label: 'Dark',
    lexemes: ['dark', 'shadow', 'night', 'dusk', 'umbra', 'eclipse', 'black', 'gloom'],
    archetypes: [
  ...
  Object.freeze({
    id: 'psychic',
    label: 'Psychic',
    lexemes: ['psychic', 'mind', 'dream', 'memory', 'thought', 'psyche', 'vision', 'gaze'],
    archetypes: [
  ...
  Object.freeze({
    id: 'metal',
    label: 'Metal',
    lexemes: ['metal', 'iron', 'steel', 'silver', 'copper', 'blade', 'chain', 'bronze'],
    archetypes: [
